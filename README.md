...
<head>
    <!-- JSPT CSS -->
    <link rel="stylesheet" href="https://cdn.wokki20.nl/content/jspt-v2.0.0/jspt.css">
    <!-- JSPT JavaScript -->
    <script src="https://cdn.wokki20.nl/content/jspt-v2.0.0/jspt.min.js"></script>
</head>
<body>
    <script>
...
<script type="module">
import { makeToast, makePopup } from 'https://cdn.wokki20.nl/content/jspt-v2.0.0/jspt.module.js';
...
```html
<!-- v2.0.0 - Minified (10KB) -->
<script src="https://cdn.wokki20.nl/content/jspt-v2.0.0/jspt.min.js"></script>

<!-- v2.0.0 - Full with JSDoc (24KB) -->
<script src="https://cdn.wokki20.nl/content/jspt-v2.0.0/jspt.js"></script>

<!-- v2.0.0 - ES Module (21KB) -->
<script type="module" src="https://cdn.wokki20.nl/content/jspt-v2.0.0/jspt.module.js"></script>

<!-- CSS -->
<link rel="stylesheet" href="https://cdn.wokki20.nl/content/jspt-v2.0.0/jspt.css">

<!-- TypeScript Definitions -->
/// <reference path="https://cdn.wokki20.nl/content/jspt-v2.0.0/jspt.d.ts" />
```
...
|----------|----------------|
| Production website | `content/jspt-v2.0.0/jspt.min.js` (versioned) |
| Testing/Development | `dynamic/jspt/jspt.js` (dynamic) |
| Maximum performance | `content/jspt-v2.0.0/jspt.min.js` (minified + cached) |
| ES6 Projects | `content/jspt-v2.0.0/jspt.module.js` (versioned module) |
| TypeScript Projects | `content/jspt-v2.0.0/jspt.d.ts` (type definitions) |
...
<body>
    ...
    <script type="module">
        import { makeToast } from 'https://cdn.wokki20.nl/content/jspt-v2.0.0/jspt.module.js';
...
- ✅ **Preload for faster loading:**
  ```html
  <link rel="preload" href="https://cdn.wokki20.nl/content/jspt-v2.0.0/jspt.min.js" as="script">
  <link rel="preload" href="https://cdn.wokki20.nl/content/jspt-v2.0.0/jspt.css" as="style">
  ```
